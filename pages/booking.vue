        ...
        <div class="flex-flex-col w-full sm:w-3/4 lg:w-1/2 mx-auto">
          ...
          >
            ...
            <ul class="m-1 p-1 text-sm">
              ...
              <li class="m-1 p-1">
                Please enquire with Admiral Management for accurate rates prior
                to booking. Minimum 3 night stay, 7 in Peak times.
              </li>
              <li class="m-1 p-1">
          ...
          >
            <h1 class="p-1 m-1 sm:m-2 sm:p-2 text-2xl">
              3. To make your booking please contact Admiral Management
              Services.
            </h1>
